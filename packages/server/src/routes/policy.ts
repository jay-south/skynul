...
const VALID_PROVIDERS: ProviderId[] = [
  'chatgpt', 'claude', 'deepseek', 'kimi', 'glm', 'minimax', 'openrouter', 'gemini', 'ollama'
]
...
const policyRoutes = new Hono()
  ...
  .put('/capability', zValidator('json', z.object({
  ...
  .put('/theme', zValidator('json', z.object({
  ...
  .put('/language', zValidator('json', z.object({
  ...
  .put('/provider', zValidator('json', z.object({
    active: z.string()
  })), async (c) => {
  ...
  .put('/provider/model', zValidator('json', z.object({
  ...
  .put('/task-memory', zValidator('json', z.object({
    enabled: z.boolean()
  })), async (c) => {
  ...
  .put('/task-auto-approve', zValidator('json', z.object({
    enabled: z.boolean()
  })), async (c) => {
    const { enabled } = c.req.valid('json')
  ...
  .put('/workspace', zValidator('json', z.object({
