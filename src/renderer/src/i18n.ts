...
const MESSAGES = {
  en: {
    ...
    ollama_connected: 'Running locally',
    ollama_not_running: 'Ollama is not running.',
    ollama_installed_start: 'Ollama is installed. Open a terminal and run:',
    ollama_not_installed: 'Ollama is not installed yet.',
    ollama_step1: '1. Install Ollama',
    ollama_step2: '2. Open a terminal and run:',
    ollama_step2_cmd: 'ollama serve',
    ollama_step3: '3. In another terminal, download a model (qwen2.5 recommended for agents):',
    ollama_step3_cmd: 'ollama pull qwen3.5:27b',
    ollama_step4: '4. Click Retry below',
    ollama_select_model: 'Select model',
    ollama_no_models: 'No models found. Open a terminal and run: ollama pull qwen3.5:27b',
    ollama_model_saved: 'Model saved',
  ...
  es: {
    ...
    ollama_connected: 'Corriendo localmente',
    ollama_not_running: 'Ollama no está corriendo.',
    ollama_installed_start: 'Ollama está instalado. Abrí una terminal y ejecutá:',
    ollama_not_installed: 'Ollama no está instalado todavía.',
    ollama_step1: '1. Instalá Ollama',
    ollama_step2: '2. Abrí una terminal y ejecutá:',
    ollama_step2_cmd: 'ollama serve',
    ollama_step3: '3. En otra terminal, descargá un modelo (qwen2.5 recomendado para agentes):',
    ollama_step3_cmd: 'ollama pull qwen3.5:27b',
