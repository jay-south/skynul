...
import { t } from "../../i18n";
import { usePolicy, useSetProvider, useSetOpenAIModel } from "../../queries";
        ...
        activeProvider !== "ollama" && (
          <div className="settingsSection">
            <div className="settingsLabel">
              {t(
                lang,
                `settings_${activeProvider}_key` as `settings_${typeof activeProvider}_key`,
              )}
            </div>
            <div className="settingsField">
              ...
              <div className="settingsFieldHint">
                {t(
                  lang,
                  `${activeProvider}_key_get_from` as `${typeof activeProvider}_key_get_from`,
                )}
              </div>
            </div>
          </div>
