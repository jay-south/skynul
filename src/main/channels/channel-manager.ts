...
import type { ChannelId, ChannelSettings, ChannelGlobalSettings } from '../../shared/channel'
...
export class ChannelManager {
  ...
  private get globalPath(): string {
    return join(app.getPath('userData'), 'channels', 'global.json')
  }
  ...
  private async saveGlobal(): Promise<void> {
    const dir = join(app.getPath('userData'), 'channels')
